...
<head>
  <title>Calificación de servicios</title>
  <!-- videojs -->
...
<body>
  ...
  <div class="container-services row">
    <!-- Recomendados -->
    <div class="content-filter-recommended col-md-4">
    ...
    <div class="content-service col-8">
      <!-- Servicio 1 -->
      <div class="target-service card">
        ...
        <div class="target-footer card-footer">
          ...
          <div class="content-comments collapse" id="comentario1">
            ...
            <div class="box-comment">
              ...
              <div class="box-content-commented">
                ...
                <a href="javascript:void(0)" data-toggle="modal" data-target="#modal-report" class="report">Reportar</a>
              </div>
            </div>
            ...
            <div class="box-comment">
              ...
              <div class="box-content-commented">
                ...
                <a href="javascript:void(0)" class="report">Reportar</a>
              </div>
            </div>
          ...
          <div class="write-comment">
            ...
            <button type="button" class="btn btn-primary" id="btn-send-1"><i class="fa fa-send"></i></button>
          </div>
        </div>
      </div>
        ...
        <div class="modal-body">
          ...
          <form id="formulario-image">
              <div class="form-group">
                  ...
                  <button type="button" id="btn-subir-imagen" class="btn btn-block btn-primary">
