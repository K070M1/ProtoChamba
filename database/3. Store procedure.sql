...
CALL spu_modificar_actividades(6, 2, '2022-04-25', '2022-04-25', '06:00', '14:00', 'Actualizado', 'Sin descripcion', 'Lima');
...
-- USUARIOS POPULARES
DELIMITER $$
CREATE PROCEDURE spu_usuarios_populares()
BEGIN
	SELECT * FROM usuarios;
END $$
...
CALL spu_grafico_reportes_year();
